...
#define ATEAMS_TOPOLOGY_PERSISTENCE_STANDARD_H
...
namespace ATEAMS::topology::persistence {
	 ...
	 * algorithm of Edelsbrunner, Harer, and Zomorodian. Base implementation to
	 * which all overloads forward.
	 * 
	...
	inline std::vector<int> standard(
	 ...
	 * @brief Computes the persistent homology of a complex over \f$\Z/p\Z\f$
	 * coefficients, where \f$p\f$ is prime. Implements the standard persistence
	 * algorithm of Edelsbrunner, Harer, and Zomorodian. Convenience overload.
	 * 
	 * @tparam RingLike A coefficient @ref Ring, like @ref Zp or @ref Q.
	 * 
	 * @param complex A (pointer to) a @ref ATEAMS::complexes::Complex with a flat boundary matrix.
	 ...
	 * @brief Computes the persistent homology of a complex over \f$\Z/p\Z\f$
	 * coefficients, where \f$p\f$ is prime. Implements the standard persistence
	 * algorithm of Edelsbrunner, Harer, and Zomorodian. Convenience overload for
	 * persistence of a single dimension.
	 * 
	 * @tparam RingLike A coefficient @ref Ring, like @ref Zp or @ref Q.
	 * 
	 * @param complex A (pointer to) a @ref ATEAMS::complexes::Complex with a flat boundary matrix.
...
#include "ATEAMS++/topology/persistence/standard.tpp"
