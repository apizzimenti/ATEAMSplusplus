...
#define ATEAMS_TOPOLOGY_PERSISTENCE_STAGGER_H
...
namespace ATEAMS::topology::persistence {
	 ...
	 * @ref ATEAMS::topology::persistence::twist on blocks of alternating dimension.
	 * Base implementation to which all overloads forward.
	 * 
	...
	/**
	 * @brief Computes the persistent homology of a complex over \f$\Z/p\Z\f$
	 * coefficients, where \f$p\f$ is prime. Convenice overload.
	 * 
	 * @tparam RingLike A coefficient @ref Ring, like @ref Zp or @ref Q.
	 * 
	 * @param complex A (pointer to) a @ref ATEAMS::complexes::Complex with a flat boundary matrix.
...
#include "ATEAMS++/topology/persistence/stagger.tpp"
